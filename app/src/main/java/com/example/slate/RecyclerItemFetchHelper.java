...
import com.example.slate.Adapter.ToDoAdapter;

public class RecyclerItemFetchHelper extends ItemTouchHelper.SimpleCallback {
    private ToDoAdapter adapter;

    public RecyclerItemFetchHelper(ToDoAdapter adapter){
    ...
    public void onSwiped(final RecyclerView.ViewHolder viewHolder, int direction){
        ...
        if(direction == ItemTouchHelper.LEFT){
            ...
            builder.setMessage("Are You Sure You Want To Delete This Tasks ??");
